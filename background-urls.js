...
// Using Cloudinary URLs to avoid issues with local file loading
export const BACKGROUND_URLS = {
    ...
    'Lights': 'https://res.cloudinary.com/dhirimesk/image/upload/v1763774731/Grow_House_aggrgh.png',
    ...
    'ghost': null // ghost background doesn't have a URL in your list
};

// Function to get background URL by name
